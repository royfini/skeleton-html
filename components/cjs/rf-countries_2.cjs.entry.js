...
const Countries = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd607b86faef3c1a3a1245e83c06cfd425c7330ad' }, this.loading ? (index.h("rf-skeleton", null)) : (index.h("div", { class: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 xl:grid-cols-5" }, this.data.map(c => {
            return (index.h("div", { class: "rounded-md border-2 border-gray-700 bg-gray-300 w-60 h-65 mx-auto my-5 p-5" }, index.h("img", { src: c.img, class: "w-60 h-36" }), index.h("div", { class: "mt-5 h-30" }, index.h("p", { class: "font-bold text-xl font-mono" }, c.name), index.h("p", { class: "font-semibold" }, c.capital))));
        })))));
    }
    get element() { return index.getElement(this); }
};
Countries.style = RfCountriesStyle0;
...
const Skeleton = class {
    ...
    render() {
        return (index.h("div", { key: '4698213e8c3b192150e0b1970bdf3836fa722d59', class: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 xl:grid-cols-5" }, [...Array(15)].map(_ => {
            return (index.h("div", { class: "rounded-md border-2 border-gray-700 bg-gray-300 w-60 h-65 mx-auto my-5 p-5" }, index.h("img", { class: "w-60 h-36 skeleton" }), index.h("div", { class: "mt-5 h-30" }, index.h("p", { class: "font-bold text-xl font-mono skeleton w-40 h-6 mb-2" }), index.h("p", { class: "font-semibold skeleton w-24 h-4" }))));
        })));
    }
    get element() { return index.getElement(this); }
};
Skeleton.style = RfSkeletonStyle0;

exports.rf_countries = Countries;
exports.rf_skeleton = Skeleton;

//# sourceMappingURL=rf-countries_2.cjs.entry.js.map